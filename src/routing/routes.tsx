...
const navClass = ({ isActive }: { isActive: boolean }) =>
  `rounded-lg px-4 py-2 text-base font-medium ${isActive ? 'bg-violet-100 text-violet-800' : 'text-gray-600 hover:bg-gray-100'}`
    ...
    <div className="min-h-screen bg-gray-100">
      <nav className="border-b border-gray-200 bg-white px-4 py-3 shadow-sm">
        <div className="mx-auto flex max-w-5xl gap-4">
          ...
          <NavLink to="/resubmit" className={navClass}>
            Resubmission
          </NavLink>
        </div>
      </nav>
